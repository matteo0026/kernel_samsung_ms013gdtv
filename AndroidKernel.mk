...
MS01DTV_LTN_PROJECT ?= $(shell $(PERL) -e '$$of = "n"; while (<>) { if (/CONFIG_MACH_MS01DTV_LTN=y/) { $$of = "y"; break; } } print $$of;' $(KERNEL_CONFIG))
...
ifeq "$(MS01DTV_LTN_PROJECT)" "y"
DTS_FILES = $(wildcard $(TOP)/kernel/arch/arm/boot/dts/msm8226-sec-ms013gdtvltn*.dts)
endif
