...
ifeq ($(CONFIG_MACH_MS01DTV_LTN),y)
		dtb-$(CONFIG_ARCH_MSM8226)	+= msm8226-sec-ms013gdtvltn-r00.dtb
else ifeq ($(CONFIG_MACH_MS01),y)
		...
		dtb-$(CONFIG_ARCH_MSM8226)	+= msm8226-sec-craterq3g-r01.dtb
		dtb-$(CONFIG_ARCH_MSM8226)	+= msm8226-sec-craterq3g-r02.dtb
