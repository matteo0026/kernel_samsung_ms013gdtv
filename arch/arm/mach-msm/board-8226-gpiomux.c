...
#if defined(CONFIG_MACH_MS01_CHN_CTC) || defined(CONFIG_MACH_CRATERVE_CHN_CTC)|| defined(CONFIG_MACH_MS01_EUR_3G) || defined(CONFIG_MACH_CRATERQ)
...
#if !defined(CONFIG_MACH_MS01_CHN_CTC) && !defined(CONFIG_MACH_CRATERVE_CHN_CTC) && !defined(CONFIG_MACH_CRATERQ) && !defined(CONFIG_MACH_MS01DTV_LTN)
...
#else
#if !defined(CONFIG_MACH_MS01DTV_LTN)
...
static struct gpiomux_setting gpio_isdbt_pwr_en_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
};
static struct gpiomux_setting gpio_isdbt_pwr_en_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
};
static struct gpiomux_setting gpio_isdbt_pwr_en2_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
};
static struct gpiomux_setting gpio_isdbt_pwr_en2_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
};
static struct gpiomux_setting gpio_isdbt_rst_active_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
};
static struct gpiomux_setting gpio_isdbt_rst_suspend_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config msm_blsp_configs[] __initdata = {
...
#if !defined(CONFIG_MACH_MILLET3G_EUR) && !defined(CONFIG_MACH_CS03_SGLTE) && !defined(CONFIG_MACH_CRATERQ) && !defined(CONFIG_MACH_MS01DTV_LTN)
	{
...
#endif
#if !defined(CONFIG_MACH_MILLET3G_EUR) && !defined(CONFIG_MACH_S3VE_CHN_OPEN) &&!defined(CONFIG_MACH_S3VE_CHN_CMCC) && !defined(CONFIG_MACH_S3VE_CHN_CTC) && !defined(CONFIG_MACH_CS03_SGLTE) && !defined(CONFIG_MACH_MS01DTV_LTN)
	{
	...
	{
		.gpio	   = 36,	/* ISDBT PWR_EN2 */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_isdbt_pwr_en2_active_cfg,
			[GPIOMUX_SUSPENDED] = &gpio_isdbt_pwr_en2_suspend_cfg,
		},
	},
	{
		.gpio	   = 49,	/* ISDBT IN */
	...
	{
		.gpio	   = 110,	/* ISDBT PWR_EN */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_isdbt_pwr_en_active_cfg,
			[GPIOMUX_SUSPENDED] = &gpio_isdbt_pwr_en_suspend_cfg,
		},
	},
	{
		.gpio	   = 67,	/* ISDBT RST */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_isdbt_rst_active_cfg,
			[GPIOMUX_SUSPENDED] = &gpio_isdbt_rst_suspend_cfg,
		},
	},
	{
		.gpio	   = 74,	/* CHECK_DS_SS */
...
#elif defined(CONFIG_MACH_MS01_EUR_3G) || defined(CONFIG_MACH_CRATERQ)
	{
		.gpio = 27, /* CAM_MCLK1 */
		.settings = {
...
#if !defined(CONFIG_MACH_MS01_CHN_CTC) && !defined(CONFIG_MACH_CRATERVE_CHN_CTC) && !defined(CONFIG_MACH_MS01DTV_LTN)
	{
...
#elif defined(CONFIG_MACH_MS01DTV_LTN)
static struct msm_gpiomux_config msm8226_nc_gpio_cfgs[] __initdata = {
	NC_GPIO_CONFIG(10),
	NC_GPIO_CONFIG(11),
	NC_GPIO_CONFIG(62),
...
#if defined(CONFIG_MACH_MS01_EUR_3G) && !defined(CONFIG_MACH_MS01DTV_LTN)
